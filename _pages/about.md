...
I obtained my Masters from IIIT Delhi under the supervision of [Prof. Sambuddho Chakravarty](https://sites.google.com/site/sambuddhochakravarty/home?authuser=0). I did my Undergrad at Jadavpur University, where I worked with [Prof. Samiran Chattopadhyay](http://www.jaduniv.edu.in/profile.php?uid=615). Prior work experience includes <i>Applied Scientist II Intern</i> with the [Central Machine Learning Team](https://www.amazon.jobs/en/teams/machine-learning) at [Amazon Science](https://www.amazon.science/), <i>Summer Research Intern</i> at [IBM Research](https://research.ibm.com/), and four years of full-time experience as a <i>Technology Consultant</i> with [PwC India](https://www.pwc.in/).
